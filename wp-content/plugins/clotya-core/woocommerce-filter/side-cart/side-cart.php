...
## Scripts
*************************************************/
function clotya_side_cart_scripts() {
...
add_action( 'wp_enqueue_scripts', 'clotya_side_cart_scripts' );

if ( ! function_exists( 'clotya_side_cart' ) ) {
	function clotya_side_cart(){
		?>
			<div class="cart-widget-side">
				<div class="site-scroll">
					<div class="cart-side-header">
						<div class="cart-side-title"><?php esc_html_e('Shopping Cart', 'clotya-core'); ?></div>
...
add_action('wp_footer', 'clotya_side_cart');
...
add_action( 'wp_ajax_nopriv_sidecart_quantity_button', 'clotya_sidecart_quantity_button_callback' );
add_action( 'wp_ajax_sidecart_quantity_button', 'clotya_sidecart_quantity_button_callback' );
function clotya_sidecart_quantity_button_callback() {
